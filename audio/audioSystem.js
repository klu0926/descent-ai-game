const DEFAULT_SOUND_EFFECT_FILES = {
    block: [
        "resources/sounds/block/block (1).mp3",
        "resources/sounds/block/block (2).mp3"
    ],
    hit: [
        "resources/sounds/hit/hit (1).mp3",
        "resources/sounds/hit/hit (2).mp3",
        "resources/sounds/hit/hit (3).mp3",
        "resources/sounds/hit/hit (4).mp3",
        "resources/sounds/hit/hit (5).mp3"
    ],
    slash: [
        "resources/sounds/slash/slash (1).mp3",
        "resources/sounds/slash/slash (2).mp3",
        "resources/sounds/slash/slash (3).mp3",
        "resources/sounds/slash/slash (4).mp3"
    ],
    swoosh: ["resources/sounds/swoosh/swoosh.mp3"]
};
